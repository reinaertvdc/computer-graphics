// https://github.com/seanrowens/oObjLoader/blob/master/com/owens/oobjloader/parser/StringUtils.java
...
public class StringUtils {
    ...
    public static int[] parseListVerticeNTuples(String list, int expectedValuesPerTuple) {
        ...
        ArrayList<Integer> returnList = new ArrayList<Integer>();
        Integer emptyMarker = new Integer(Model3d.EMPTY_VERTEX_VALUE);
