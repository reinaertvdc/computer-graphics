// partially taken from https://github.com/seanrowens/oObjLoader/blob/master/com/owens/oobjloader/builder/Build.java
import java.util.*;
...
public class Model3d {
	...
	public final static int NO_SMOOTHING_GROUP = 0;
    public final static int EMPTY_VERTEX_VALUE = Integer.MIN_VALUE;
    public final static int MTL_KA = 0;
    public final static int MTL_KD = 1;
    public final static int MTL_KS = 2;
    public final static int MTL_TF = 3;
    public final static int MTL_MAP_KA = 0;
    public final static int MTL_MAP_KD = 1;
    public final static int MTL_MAP_KS = 2;
    public final static int MTL_MAP_NS = 3;
    public final static int MTL_MAP_D = 4;
    public final static int MTL_DECAL = 5;
    public final static int MTL_DISP = 6;
    public final static int MTL_BUMP = 7;
    public final static int MTL_REFL_TYPE_UNKNOWN = -1;
    public final static int MTL_REFL_TYPE_SPHERE = 0;
    public final static int MTL_REFL_TYPE_CUBE_TOP = 1;
    public final static int MTL_REFL_TYPE_CUBE_BOTTOM = 2;
    public final static int MTL_REFL_TYPE_CUBE_FRONT = 3;
    public final static int MTL_REFL_TYPE_CUBE_BACK = 4;
    public final static int MTL_REFL_TYPE_CUBE_LEFT = 5;
    public final static int MTL_REFL_TYPE_CUBE_RIGHT = 6;
    ...
    /** The collision box of this 3d model. */
	private ColBox $colBox;
	//Display list index
	private int $listIndex;

	/**
	 * Constructs a Model3d.
	 */
	public Model3d() {
		faces = new ArrayList<>();
		$colBox = new ColBox();
	...
	/**
	 * Returns the collision box of this 3d model.
	 * @return the collision box of this 3d model
	 */
	public ColBox getColBox() {
		return new ColBox($colBox);
	}
	
	public void setColbox(ColBox box) {
		$colBox = new ColBox(box);
	}
	...
	public void draw(boolean useCallList) {
		if(useCallList) {
    ...
    public void addVertexGeometric(float x, float y, float z) {
        verticesG.add(new Vector3d(x, y, z));
...
//        System.err.println("Parsed face=" + face);
        ...
        for (int i = 0; i < face.vertices.size(); i++)
        	$colBox.include(face.vertices.get(i).v);
